  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          howto: "O endereço público da loja, SEM barra no final. Ex.: https://lumidocura.shop.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          howto: 'Formato "Nome <email@seudominio.com>". Ex.: Lumi Doçura <contato@lumidocura.shop>.',
        },
        {
          ...
          howto: "Um e-mail SEU. Quando o cliente clicar em 'Responder' no e-mail de confirmação, vai pra este endereço. Ex.: contato@lumidocura.shop.",
        },
      ],
    },
    {
