  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          howto: "O endereço público da loja, SEM barra no final. Ex.: https://lumidocura.com.br.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          howto: 'Formato "Nome <email@seudominio.com>". Ex.: Lumi Doçura <contato@lumidocura.com.br>.',
        },
        {
          ...
          howto: "Um e-mail SEU. Quando o cliente clicar em 'Responder' no e-mail de confirmação, vai pra este endereço. Ex.: contato@lumidocura.com.br.",
        },
      ],
    },
    {
